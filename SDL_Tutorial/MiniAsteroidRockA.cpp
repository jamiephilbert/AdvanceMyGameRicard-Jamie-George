...
void MiniAsteroidRockA::CheckScreenBounds()
{
	if (Position().x < -11) {
...
MiniAsteroidRockA::MiniAsteroidRockA() :Texture("MiniAsteroidRock1.png", 0, 0, 8, 10)
{
...
MiniAsteroidRockA::~MiniAsteroidRockA()
{
	m_pRandom = nullptr;
}

void MiniAsteroidRockA::Update()
{
	Translate(Vector2(randVelocityX, randVelocityY), GameEntity::World);
	CheckScreenBounds();
}

void MiniAsteroidRockA::Render()
{
	Texture::Render();
}
