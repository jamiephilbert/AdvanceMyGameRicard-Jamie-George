...
StartMenu::StartMenu()
{
	...
	m_pPlayGame = new Texture("Play Game", "ARCADE.TTF", 70, { 230,230,230 });
	m_pHighScoreMenu = new Texture("High Score", "ARCADE.TTF", 70, { 230,230,230 });
	m_pCursor = new Texture("Cursor.png");

	// Bottom Bar Entities
	m_pBottomBar = new GameEntity(Graphics::SCREEN_WIDTH * 0.5f, Graphics::SCREEN_HEIGHT * 0.7f);
	m_pAtari = new Texture("ATARI", "Raleway-BlackItalic.ttf", 70, { 200,0,0 });
	m_pDates = new Texture("1979 ATARI LTD.", "Raleway-Bold.ttf", 32, { 230,230,230 });
	m_pRights = new Texture("ALL RIGHTS RESERVED", "Raleway-ExtraBold.ttf", 32, { 230,230,230 });
	...
	m_pCursor->Position(-210.f, -44.9f);
